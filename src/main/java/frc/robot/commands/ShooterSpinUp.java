...
public class ShooterSpinUp extends Command {
  ...
  public ShooterSpinUp(Shooter shooter, Hood hood, Supplier<Pose2d> robotPose, String position) {
    m_shooter = shooter;
    m_hood = hood;
  ...
  public boolean isFinished() {
    return m_shooter.getLVelocity() >= m_shot.m_shooterRPM
        && m_shooter.getMVelocity() >= m_shot.m_shooterRPM
        && m_shooter.getRVelocity() >= m_shot.m_shooterRPM;
  }
