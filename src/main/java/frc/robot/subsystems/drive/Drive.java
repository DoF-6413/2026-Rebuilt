...
public class Drive extends SubsystemBase {
  ...
  private final Alert m_gyroDisconnectedAlert =
      new Alert("Disconnected gyro, using m_kinematics as fallback.", AlertType.kError);

  private final SwerveDriveKinematics m_kinematics =
      new SwerveDriveKinematics(getModuleTranslations());
  private Rotation2d m_rawGyroRotation = Rotation2d.kZero;
  private final SwerveModulePosition[] m_lastModulePositions = // For delta tracking
  ...
  private final SwerveDrivePoseEstimator m_poseEstimator =
      new SwerveDrivePoseEstimator(
          m_kinematics, m_rawGyroRotation, m_lastModulePositions, Pose2d.kZero);
  ...
  public Drive(
    ...
    m_modules[0] = new Module(flModuleIO, 0, TunerConstants.FrontLeft);
    m_modules[1] = new Module(frModuleIO, 1, TunerConstants.FrontRight);
    m_modules[2] = new Module(blModuleIO, 2, TunerConstants.BackLeft);
    m_modules[3] = new Module(brModuleIO, 3, TunerConstants.BackRight);
    ...
    AutoBuilder.configure(
        ...
        new PPHolonomicDriveController(
            new PIDConstants(3.25, 0.0, 0.0), new PIDConstants(15.0, 0.0, 0.0)),
        PP_CONFIG,
  ...
  public void periodic() {
    ...
    for (int i = 0; i < sampleCount; i++) {
      ...
      if (m_gyroInputs.connected) {
        ...
        // Use the angle delta from the m_kinematics and module deltas
    ...
    // Update gyro alert
    m_gyroDisconnectedAlert.set(
        !m_gyroInputs.connected && RobotStateConstants.currentMode != Mode.SIM);
  }
  ...
  /**
   * Stops the drive and turns the m_modules to an X arrangement to resist movement. The m_modules
  ...
  /** Returns the module states (turn angles and drive velocities) for all of the m_modules. */
  ...
  /** Returns the module positions (turn angles and drive positions) for all of the m_modules. */
  ...
  /** Returns the average velocity of the m_modules in rotations/sec (Phoenix native units). */
